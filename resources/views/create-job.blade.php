            ...
            <form action="{{ route('jobs.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-10">
                    <label for="inputfile" class="drop-zone"
                        ...
                        ">
                        <input type="file" name="inputfile" x-ref="fileInput" class="hidden" id="inputfile" accept=".stl"
                               @change="
                        ...
                        <div class="text-center w-full">
                            ...
                            <h3 class="text-xl font-semibold mb-2">
                                <span x-show="!fileName && !error" class="text-white">Glisser votre STL ici</span>
                                <span x-show="fileName" class="text-green-600">Fichier prêt !</span>
                                <span x-show="error" class="text-red-600">Erreur de format</span>
                            </h3>
                            <div class="h-6">
                                <span x-show="fileName" x-text="fileName" class="text-sm text-gray-500 font-mono italic"></span>
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-6">
                     ...
                     <button type="submit" class="btn" :disabled="!fileName">Lancer l'impression</button>
                </div>
            </form>
        </div>
    </div>
